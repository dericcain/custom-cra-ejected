module.exports = function(wallaby) {
  ...
  process.env.NODE_PATH +=
    ...
    path.delimiter +
    path.join(__dirname, 'node_modules/daxko-react-scripts/node_modules');
  ...
  return {
    ...
    setup: wallaby => {
      const jestConfig = require('daxko-react-scripts/scripts/utils/createJestConfig')(p =>
        require.resolve('daxko-react-scripts/' + p),
      );
